...
public class PlayerController : MonoBehaviour
{
    ...
    // Funções para o javascript
    /*
    void PlayerStep(string direction)
    {
    ...
    */
    ...
    void PlayerInclination(string direction)
    {
        if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 2 ||
        ...
        {
            //// =====> DIREÇÃO DIREITA <=====
            GetComponent<Animator>().SetBool("Right One", direction == "R1");
            GetComponent<Animator>().SetBool("Right Two", direction == "R2");
            GetComponent<Animator>().SetBool("Right Three", direction == "R3");
            GetComponent<Animator>().SetBool("Right Four", direction == "R4");
            GetComponent<Animator>().SetBool("Right Five", direction == "R5");
            //// =====> DIREÇÃO ESQUERDA <=====
            GetComponent<Animator>().SetBool("Left One", direction == "L1");
            GetComponent<Animator>().SetBool("Left Two", direction == "L2");
            GetComponent<Animator>().SetBool("Left Three", direction == "L3");
            GetComponent<Animator>().SetBool("Left Four", direction == "L4");
            GetComponent<Animator>().SetBool("Left Five", direction == "L5");
        }
    }

    /*
    void PlayerHands_Javascript(string direction){
        if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 2 ||
            UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 5 ||
            UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex == 8)
        {
